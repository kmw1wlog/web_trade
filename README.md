...
“단타 조건식, 감이 아니라 루틴으로 정리하세요.”

인스타그램에서 유입된 사용자가 전자책, 프리미엄 노트, 기능웹, 모의투자 리그, 앱/강의 대기 신청으로 이어지는 세일즈형 투자 교육/도구 웹 MVP입니다. 홈페이지는 블로그나 무료자료실이 아니라 유료 상품을 먼저 보여주는 전문가형 랜딩 페이지입니다.
